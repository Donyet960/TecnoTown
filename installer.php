...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Hola_2fc06387a67102234282_20210312074213_archive.zip';
	const ARCHIVE_SIZE		 = '67249175';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2fc0638-12074213';
    const SECONDARY_PACKAGE_HASH = 'c2b3c71-12074213';
	const VERSION			 = '1.4.0';
